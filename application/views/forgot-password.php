					...
					<div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
						...
						<div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
							...
							<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
								<!--begin::Form-->
								<?=form_open('auth/forgotPassword',['method'=>'post','class'=>'form w-100'])?>
									<!--begin::Heading-->
									...
									<div class="d-grid mb-10">
										<button type="submit" class="btn btn-primary" name="signin" value="1">
											<!--begin::Indicator label-->
											<span class="indicator-label">Send Forget Password Link</span>
											<!--end::Indicator label-->
									...
									<div class="d-grid mb-10">
										<a class="btn btn-success" href="<?=site_url('auth/signin')?>">
											<!--begin::Indicator label-->
