<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
	...
	<div class="content flex-row-fluid" id="kt_content">
		...
		<!--begin::Layout-->
		<?=form_open('recruitment/offering_templatep',['id'=>'offering-form'])?>
				...
				<div class="card mb-10">
					<div class="card-header">
						<div class="card-title">
							Offering Letter Template (<?=strtoupper($language)?>)
						</div>
						<div class="card-toolbar">
							<button type="button" class="btn btn-success" onclick="generate_offering_template()">
						...
						<div class="mb-0">
							<div class="row mb-5">
								<!--begin::Col-->
									...
									<a class="btn btn-warning" href="<?=site_url('recruitment/offering_template/'.$language2)?>">Switch to <?=strtoupper($language2)?></a>
...
<script>
    ...
    function generate_offering_template(){
		var ajax_data="";
		ajax_data=$("#vacancy-form").serialize();
		startloading("content-page-loader");
		$.ajax({
			url:"<?=site_url('recruitment/generate_offering_template/'.$language)?>",
			method:"get",
			dataType:"JSON",
			data:ajax_data,
